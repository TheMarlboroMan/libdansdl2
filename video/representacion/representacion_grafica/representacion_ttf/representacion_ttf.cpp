...
/**
* Inicio de representación estática...
*/

Representacion_TTF_estatica::Representacion_TTF_estatica(const Fuente_TTF& fuente, SDL_Color color, const std::string& texto)
	:Representacion_TTF(fuente, color, texto)
{

}

Representacion_TTF_estatica::Representacion_TTF_estatica(const Fuente_TTF& fuente, Uint8 r, Uint8 g, Uint8 b, Uint8 a, const std::string& texto)
	:Representacion_TTF(fuente, r, g, b, a, texto)
{

}

Representacion_TTF_estatica::Representacion_TTF_estatica(const Fuente_TTF& fuente, SDL_Color color)
	:Representacion_TTF(fuente, color)
{

}

Representacion_TTF_estatica::Representacion_TTF_estatica(const Representacion_TTF_estatica& o)
	:Representacion_TTF(o) 
{

}

Representacion_TTF_estatica::~Representacion_TTF_estatica()
{

}

Representacion_TTF_estatica& Representacion_TTF_estatica::operator=(const Representacion_TTF_estatica& o)
{
	Representacion_TTF::operator=(o);
	return *this;
}

/**
* Inicio de representación dinámica.
*/

Representacion_TTF_dinamica::Representacion_TTF_dinamica(const Fuente_TTF& fuente, SDL_Color color, const std::string& texto)
	:Representacion_TTF(fuente, color, texto)
{

}

Representacion_TTF_dinamica::Representacion_TTF_dinamica(const Fuente_TTF& fuente, Uint8 r, Uint8 g, Uint8 b, Uint8 a, const std::string& texto)
	:Representacion_TTF(fuente, r, g, b, a, texto)
{

}

Representacion_TTF_dinamica::Representacion_TTF_dinamica(const Fuente_TTF& fuente, SDL_Color color)
	:Representacion_TTF(fuente, color)
{

}

Representacion_TTF_dinamica::Representacion_TTF_dinamica(const Representacion_TTF_dinamica& o)
	:Representacion_TTF(o) 
{

}

Representacion_TTF_dinamica::~Representacion_TTF_dinamica()
{

}

Representacion_TTF_dinamica& Representacion_TTF_dinamica::operator=(const Representacion_TTF_dinamica& o)
{
	Representacion_TTF::operator=(o);
	return *this;
}
