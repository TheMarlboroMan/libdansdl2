...
class Representacion_primitiva_lineas_caja_estatica:public Representacion_primitiva_caja
{
	public:
	...
	Representacion_primitiva_lineas_caja_estatica(const SDL_Rect& p_pos, Uint8 pr, Uint8 pg, Uint8 pb):Representacion_primitiva_caja(p_pos, pr, pg, pb){}
	Representacion_primitiva_lineas_caja_estatica(const Representacion_primitiva_caja_estatica& p_otra):Representacion_primitiva_caja(p_otra) {}
	virtual ~Representacion_primitiva_lineas_caja_estatica() {}
	Representacion_primitiva_lineas_caja_estatica& operator=(const Representacion_primitiva_lineas_caja_estatica& p_otro)
	{
		Representacion_primitiva_caja::operator=(p_otro);
		return *this;
	}
...
class Representacion_primitiva_lineas_caja_dinamica:public Representacion_primitiva_caja
{
	public:
	...
	Representacion_primitiva_lineas_caja_dinamica(const SDL_Rect& p_pos, Uint8 pr, Uint8 pg, Uint8 pb):Representacion_primitiva_caja(p_pos, pr, pg, pb){}
	Representacion_primitiva_lineas_caja_dinamica(const Representacion_primitiva_caja_dinamica& p_otra):Representacion_primitiva_caja(p_otra) {}
	virtual ~Representacion_primitiva_lineas_caja_dinamica() {}
	Representacion_primitiva_lineas_caja_dinamica& operator=(const Representacion_primitiva_lineas_caja_dinamica& p_otro)
	{
		Representacion_primitiva_caja::operator=(p_otro);
		return *this;
	}
